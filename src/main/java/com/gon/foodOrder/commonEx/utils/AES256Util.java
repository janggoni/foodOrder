...
public class AES256Util {
    ...
    final static String SECRET_KEY = "gksdideorydbrqnakdmarjsrkddoq123"; //32bit
    static String IV = "akdmarjsrkddoq12"; //16bit
    ...
    //암호화
    public static String AES_Encode(String str, String secretKey, String strIV) throws java.io.UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    	if(secretKey == null || strIV == null) {
    		return "";
    	}
    ...
    //복호화
    public static String AES_Decode(String str, String secretKey, String strIV) throws java.io.UnsupportedEncodingException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
    	if(secretKey == null || strIV == null) {
    		return "";
    	}
    	byte[] keyData = secretKey.getBytes();
